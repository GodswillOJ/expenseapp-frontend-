...
function updateValues () {
    ...
    totalIncomeText.innerText = totalIncome;
        //this is to get all positive values inputed into the li
...
function updateLocalStorage(){
    ...
    // this is to enter all transactions in the storage
    // JASON Javascript Object Noation
    // this helps to interact with something on the local storage
}
